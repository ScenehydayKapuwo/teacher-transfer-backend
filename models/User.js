...
const User = sequelize.define('User', {
  ...
  role: { type: DataTypes.ENUM('teacher', 'headteacher', 'admin','debs', 'ministry admin'), defaultValue: 'teacher' },
  tsno: { type: DataTypes.STRING, allowNull: false,  unique: true },
  teacherProfileId: { type: DataTypes.INTEGER, references: { model: Teacher, key: 'id' } }
});
